defmodule LocalCafeWeb.UserSettingsController do
  use LocalCafeWeb, :controller

  alias LocalCafe.Accounts
  alias LocalCafeWeb.UserAuth

  import LocalCafeWeb.UserAuth, only: [require_sudo_mode: 2]

  plug :require_sudo_mode
  plug :assign_changesets

  def edit(conn, _params) do
    render(conn, :edit, page_title: "Settings")
  end
  ...
  def update(conn, %{"action" => "update_password"} = params) do
    ...
    case Accounts.update_user_password(user, user_params) do
      ...
      {:error, changeset} ->
        render(conn, :edit, password_changeset: changeset, page_title: "Settings")
    end
  end
  ...
  def update(conn, %{"action" => "update_username"} = params) do
    ...
    case Accounts.update_username(user, user_params) do
      ...
      {:error, changeset} ->
        render(conn, :edit, username_changeset: changeset, page_title: "Settings")
    end
  end
